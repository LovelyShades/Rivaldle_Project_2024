...
var options = require('chinese-numbering/options.js');
var label = require('chinese-numbering/label.js');
...
export function numberToChinese(num, options$1) {
  const opts = options.normalizeOptions(options$1);
  const labels = label.getLabels(opts);
